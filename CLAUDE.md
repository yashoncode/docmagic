...
Stack: Gradio + Chroma (NIM-hosted nemotron embeddings) + any OpenAI-compatible
LLM API (NVIDIA NIM free tier by default). Run: `python app.py`. Test: `python test_rag.py`.
